<p align="center">
  <a href="https://v2.nonebot.dev/"><img src="http://img.sevin.cn/i/2023/01/16/63c5399a2f186.png" width="200" height="200" alt="不正经的妹妹"></a>
</p>
...
- 音乐系统：点歌、随机歌曲
- 游戏系统：人生重开系统、扫雷系统、塔罗牌系统、猜单词系统、猜成语系统、国际棋类系统、象棋系统、迷宫系统
- 视频系统：小姐姐视频
...
- 娱乐系统
  ...
  - 交互类：和我聊天、语音聊天、ChatGpt
- 工具系统：青年大学习、mc服状态查询、站长工具、天气查询、中英互译、qq估价、消息撤回、代码运行、淫语转换
- 群管系统：全体禁言、单人禁言、移出群聊、入群申请
- 表情包系统：头像表情包、文字表情包、表情包合成
- 被动功能：今日60秒推送、历史上的今天推送、戳一戳回复
- 作者介绍
- 版权声明
...
4.[Nonebot2](https://github.com/nonebot/nonebot2)和[go-cqhttp](https://github.com/Mrs4s/go-cqhttp)
